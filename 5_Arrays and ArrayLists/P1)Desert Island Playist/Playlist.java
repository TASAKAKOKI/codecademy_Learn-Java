...
Playlist.java
    ...
    class Playlist {
        public static void main(String[] args) {
            ...
            desertIslandPlaylist.add("The Simple Things");
            desertIslandPlaylist.add("Officially Missing You");
            desertIslandPlaylist.add("City of Stars");
            System.out.println(desertIslandPlaylist);
            System.out.println(desertIslandPlaylist.size());
            desertIslandPlaylist.remove(5);
            int indexA = desertIslandPlaylist.indexOf("Only One");
            int indexB = desertIslandPlaylist.indexOf("Officially Missing You");
